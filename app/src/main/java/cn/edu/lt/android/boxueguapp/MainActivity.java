...
import cn.edu.lt.android.boxueguapp.view.MyInfoView;
    ...
    private void createView(int viewIndex) {
        switch (viewIndex){
            ...
            case 2:
                //我的界面
                if (mMyInfoView == null) {
                    mMyInfoView = new MyInfoView(this);//第一次加载我的界面需要new
                    mBodyLayout.addView(mMyInfoView.getView());//添加到内容区域中
                } else {
                    mMyInfoView.getView();//非第一次加载我的界面则可以直接getView
                }
                mMyInfoView.showView();//打开可见性
                break;
        }
    }
